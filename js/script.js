...
(() => {
  ...
  const UI = {
    en: {
      ...
      hero_title: 'Welcome to <span class="accent">NAMI</span>',
    ...
    ka: {
      ...
      hero_title: '<span class="accent">NAMI</span>-ში მოგესალმებით',
    ...
    ru: {
      ...
      hero_title: 'Добро пожаловать в <span class="accent">NAMI</span>',
